...
func Test_getAbsoluteURL(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args{
				templateURL: "https://github.com/ghn-toolkit/net_http-go-template",
			},
			"https://github.com/ghn-toolkit/net_http-go-template",
		},
		{
			"successfully get absolute url from url without scheme",
			args{
				templateURL: "github.com/ghn-toolkit/net_http-go-template",
			},
			"https://github.com/ghn-toolkit/net_http-go-template",
		},
		{
